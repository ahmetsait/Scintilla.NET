...
* NOTE: I updated the Nuget package name to [ahmetsait.Scintilla5.NET](https://www.nuget.org/packages/ahmetsait.Scintilla5.NET) for those searching the gallery.

[![Nuget](https://img.shields.io/nuget/v/ahmetsait.Scintilla5.NET)](https://www.nuget.org/packages/ahmetsait.Scintilla5.NET)
...
Scintilla.NET can also be used with WPF using the [WindowsFormsHost](https://learn.microsoft.com/en-us/dotnet/api/system.windows.forms.integration.windowsformshost).
...
Scintilla.NET is in active development. If you find any issues or just have a question feel free to use the [Issues](https://github.com/ahmetsait/Scintilla.NET/issues) feature at our GitHub page. **NOTE:** I don't read the issues posted to the main fork - so if your issue is about this project, post it here.

Compiled versions which are production ready can be downloaded from [NuGet](https://www.nuget.org/packages/ahmetsait.Scintilla5.NET) or the [Releases](https://github.com/ahmetsait/Scintilla.NET/releases) page.
